...
export default function InstituicaoClient({ ong }: { ong: any }) {
        ...
        <div className="max-w-5xl mx-auto w-full flex flex-col flex-1 pb-32 animate-gentle-fade mt-8">
          ...
          {ong.qrCodeImagem && (
            <div className="relative mb-12 flex justify-center px-4">
              <div 
                onClick={() => setVideoOpen(ong.qrCodeImagem)}
                  ...
                  <div className="flex flex-col gap-4 text-sm text-taupe">
                    ...
                    {ong.telefone && (
                      <div>
                        ...
                        {Array.isArray(ong.telefone) ? ong.telefone.map((t: string, i: number) => <span key={i} className="block font-medium text-ui-text">{t}</span>) : <span className="font-medium text-ui-text">{ong.telefone}</span>}
                      </div>
                    )}
                    {ong.email && (
                      <div>
